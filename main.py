...
def slice_dataframe(main_dataframe, dataframe_name):
    parameters_mapping = {
        ...
        'label_parameters_dataframe': ['customer_no', 'customer_name', 'purchase_order', 'customer_part_number', 'product_number',
                                       'new_lot','new_DC','new_quantity', 'small_label_quantity', 'small_label_copies',
